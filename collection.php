...
$p_id = $row2['id'];
?>
                    <div class="col_6 collectionDesktop">
                      <div class="col_12 allM"> <a href="collection.php?collect=<?php echo $p_id;?>">
                        <figure> <img src="media/collection/product/<?php echo $row2['thumb']; ?>"  /> </figure>
                        </a>
                        <div class="clr"></div>
                      </div>
                    </div>
                    <div class="col_6 collectionMobile">
                      <div class="col_12 allM"> <a href="collectionMobilePage.php?id=<?php echo $p_id;?>">
                        <figure> <img src="media/collection/product/<?php echo $row2['thumb']; ?>"  /> </figure>
                        </a>
                        <div class="clr"></div>
                      </div>
...
mysql_select_db($database_tes, $tes);
$selectSQL4="SELECT * FROM products WHERE id= $c_id";
$queryset4='';
...
$sid=$row4['s_id'];
?>
          <div class="cpopbigcont">Privileged Life</br>
		  <?php
			mysql_select_db($database_tes, $tes);		 
		 ...
		 $queryset5='';
          ...
          <div class="smallcont floatL mT20 mL20"><? echo $row4['description']; ?>
          ...
          <div class="popup_social floatL">
            ...
            <div class="popupSocialIcon"><a href="#"><img src="media/images/popup/fIcon.png" /></a> <a href="https://twitter.com/share?url=http://onearmbandit.in/privileged-life/collection.php?collect=" <?php echo $p_id; ?> target="_blank"><img src="media/images/popup/tIcon.png" /></a> <a href="#"><img src="media/images/popup/pIcon.png" /></a></div>
          </div>
