  ...
  <div id="content-wrapper">
    ...
    <div id="content">
      ...
      <section>
        ...
        <div class="col_12">
        <div class="c_contact">
        <form name="form" action="submitcontact.php" method="post"id="form">
			 <div class="cbigcont">PLEASE FILL THE FORM BELOW</div>
                <div class="col_12">
                    <div class="col_4 textR pT15">Name </div>
                    <div class="col_6"><input type="text"  name="name" class="col_12" required /></div>
                </div>
               <div class="col_12">
                    <div class="col_4 textR pT15">Email </div>
                    <div class="col_6"><input type="email" name="email" class="col_12"  required  /></div>
                </div>
                <div class="col_12">
                    <div class="col_4 textR pT15">Telephone </div>
                    <div class="col_6"><input type="number" name="telephone" class=" col_12"  /></div>
                </div>
               <div class="col_12">
                    <div class="col_4 textR">Purpose </div>
                    <div class="col_8">
                    <input type="radio" name="purpose" value="business" style="padding-right:20px;" checked><label class="lable" > Business</label>
                    <input type="radio" name="purpose" value="individual"><label class="lable">Individual</label>
                    <input type="radio" name="purpose" value="press" ><label class="lable"> Press</label></select>
                   </div>
               
              </div>
              <div class="col_12">
                   <div class="col_4 textR">Message</div>
                   <div class="col_6"><textarea name="message" rows="10" class="col_12" required></textarea>
                   					 <input type="submit" value="Send" class="sendButton" /> </td></tr>
