...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the form to upload a new product</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while uploading Product. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_addproducts.php" method="post" enctype="multipart/form-data" name="addcollection" id="addcollection">
...
while($row = mysql_fetch_assoc($queryset))
{
echo('<tr><td>'.$row['title'].'</td><td><img src="../media/collection/product/'.$row["thumb"].'" width="180px" height="120px" style="margin:0;"/></td><td>'.$row['sort'].'</td>
<td>
<a href="editproducts.php?id='.$row['id'].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
<a href="process_delproducts.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr>');
}
