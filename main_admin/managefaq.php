...
$selectSQL="SELECT * FROM faq  ORDER BY sort";
$queryset='';
$queryset=mysql_query($selectSQL,$tes);
//<td>'.$row['status'].'</td>
while($row = mysql_fetch_assoc($queryset))
{
echo('<tr><td>'.$row['question'].'</td><td>'.$row['answer'].'</td><td>'.$row['sort'].'</td>
<td>
<a href="process_delfaq.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr>');
}
...
?>
    ...
    <!-- Page Head -->
         <h2>Add New </h2>
        <div class="tab-content default-tab">
              <form action="process_addfaq.php" method="post" enctype="multipart/form-data" name="addfaq" id="addfaq">
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
              <p>
                  <label><h3>Question</h3><br/>
...
<script type="text/javascript">
<!--
var sprytextfield8 = new Spry.Widget.ValidationTextField("faq_cat");
var sprytextfield6 = new Spry.Widget.ValidationTextField("new_loc_spry");
var sprytextfield7 = new Spry.Widget.ValidationTextField("faq_name_spry");
