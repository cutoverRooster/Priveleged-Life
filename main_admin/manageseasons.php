...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the form to upload a new season</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification success png_bg" <?php echo($success); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Season added Successfully. </div>
            </div>
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while uploading Season. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_addseasons.php" method="post" enctype="multipart/form-data" name="addcollection" id="addcollection">
            ...
            <p>
                  <label>Image [940px * 661px]</label>
                  <input name="image" type="file" class="text-input" id="image" />
                </p>
              <p>
                  <label>Description<br/>
                  <span id="collection_name_spry">
                <input name="description" type="text" class="text-input medium-input" id="description" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                <p>
              <label>Sort Order<br/>
...
{
echo('<tr><td>'.$row['title'].'</td><td><img src="../media/collection/season/'.$row["image"].'" width="180px" height="120px" style="margin:0;"/></td><td>'.$row['sort'].'</td>
<td>
<a href="editseasons.php?id='.$row['id'].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
<a href="process_delseasons.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr>');
}
