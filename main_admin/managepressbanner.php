...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <!-- Page Head -->
    <h2>Add New Press Banner</h2>
    <div class="content-box">
          <!-- Start Content Box -->
          <div class="content-box-header">
        <h3>Fill in the form to upload a new press banner</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="tab-content default-tab">
              <form action="process_addpressbanner.php" method="post" enctype="multipart/form-data" name="addpress" id="addpress">
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
                  <label> Title<br/>
                  <span id="press_name_spry">
...
<td>
<a href="process_delpressbanner.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr>');
}
