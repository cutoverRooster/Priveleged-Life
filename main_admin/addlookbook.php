...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <div class="tab-content default-tab">
              <form action="process_addlookbook.php" method="post" enctype="multipart/form-data" name="addproduct" id="addproduct">
            ...
            <p>
                  <label>Image Link [770px * 550px]</label>
                  <input name="image_link" type="file" class="text-input" id="image_link" />
                </p>
...
<script type="text/javascript">
<!--
var sprytextfield8 = new Spry.Widget.ValidationTextField("lookbook_cat");
