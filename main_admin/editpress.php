...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <div class="tab-content default-tab">
              <form action="process_editpress.php" method="post" enctype="multipart/form-data" name="editproduct" id="editproduct">
            <fieldset>
                ...
                <label> Date <span id="press_name_spry"></br>
                      <input name="date" type="text" class="text-input medium-input" id="date" value="<?php echo($date); ?>" />
                      <span class="textfieldRequiredMsg">A value is required.</span> </label>
                </span> </p>
                <p>
                    <label> Author <span id="press_name_spry"> </br>
                  <input name="author" type="text" class="text-input medium-input" id="author" value="<?php echo($author);?>" />
                  <span class="textfieldRequiredMsg">A value is required.</span> </label>
                    </span> </p>
                 <p>
                    <label> Excerpt</br>
                 <span id="sprytextarea1">
                  <textarea name="excerpt" id="excerpt" cols="45" rows="5" ><?php echo($excerpt); ?></textarea>
              ...
              <p> <img src="../media/images/press/<? echo ($thumb); ?>" />
