...
<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
<div>
Error Occurred while Editing Press.
</div>
</div>
...
$selectSQL='SELECT * FROM press  ORDER BY sort DESC';
$queryset='';
$queryset=mysql_query($selectSQL,$tes);
//<td>'.$row['status'].'</td>
while($row = mysql_fetch_assoc($queryset))
{
echo('<tr><td>'.$row['title'].'</td><td>'.$row['date'].'</td><td>'.$row['sort'].'</td>
<td>
<a href="editpress.php?id='.$row['id'].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
<a href="process_delpress.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr>');
}
...
?>
    ...
    <div class="clear"></div> <!-- End .clear --><!-- End .content-box --><!-- End .content-box --><!-- End .content-box -->
	  ...
	  <div id="footer">
				<small>&#169; Copyright 2011 <a href="http://onearbandit.in/privileged-life">P-LIFE</a></small>
		  </div><!-- End #footer -->
