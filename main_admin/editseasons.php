...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the form to edit the Season</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification success png_bg" <?php echo($success); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Season edited Successfully. </div>
            </div>
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while editing Season. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_editseasons.php" method="post" enctype="multipart/form-data" name="editseason" id="editseason">
            <fieldset>
                ...
                <input name="hiddenid" type="hidden" id="hiddenid" value="<?php echo($id); ?>" />
                  ...
                  <p>
                <label> Title <span id="season_name_spry">
                   ...
                   <p> <img src="../media/collection/season/<?php echo ($image); ?>" />
...
var sprytextfield7 = new Spry.Widget.ValidationTextField("season_name_spry");
