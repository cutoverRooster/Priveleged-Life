...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <div class="tab-content default-tab">
              <form action="process_editdealer.php" method="post" enctype="multipart/form-data" name="editproduct" id="editproduct">
            <fieldset>
                ...
                <p>
                  <label> Address<br/>
                   <span id="dealer_name_spry">
                <input name="address" type="text" class="text-input medium-input" id="address" value="<? echo($address); ?>" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <p>
                  <label> City <br/>
                  <span id="dealer_name_spry">
                <input name="city" type="text" class="text-input medium-input" id="city" value="<? echo($city); ?>" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
                  <label> State <br/>
                  <span id="dealer_name_spry">
                <input name="state" type="text" class="text-input medium-input" id="state" value="<? echo($state); ?>" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <p>
                  <label> Country <br/>
                  <span id="dealer_name_spry">
                <input name="country" type="text" class="text-input medium-input" id="country" value="<? echo($country); ?>" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <p>
                  <label> Zip <br/>
                  <span id="dealer_name_spry">
                <input name="zip" type="text" class="text-input medium-input" id="zip" value="<? echo($zip); ?>" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <p>
                  <label> Phone <br/>
                  <span id="dealer_name_spry">
                <input name="phone" type="text" class="text-input medium-input" id="phone" value="<? echo($phone); ?>" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
