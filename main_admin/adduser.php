...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the add a new user</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while adding user. </div>
            </div>
...
function checkPass()
{
    ...
    if(password.value == password2.value){
        ...
        <div class="tab-content default-tab">
              <form action="process_adduser.php" method="post" enctype="multipart/form-data" name="adduser" id="adduser">
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
                  <label> Name <span id="user_name_spry"><br/>
                ...
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                   ...
                   <p>
                  <label> User Name <span id="user_name_spry"><br/>
                <input name="uname" type="text" class="text-input medium-input" id="uname"  />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
                  <label> Password <span id="user_name_spry"><br/>
                <input name="password" type="password" class="text-input medium-input" id="password"  />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
                  <label> Confirm Password <span id="user_name_spry"><br/>
                <input name="password2" type="password"  id="password2" class="text-input medium-input" onkeyup="checkPass(); return false;" />
                <span id="confirmMessage" class="confirmMessage"></span></label>
                  </span> </p>
