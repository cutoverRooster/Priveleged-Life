...
<?php $index = 1;
 ...
 $selectSQL="SELECT * FROM banner WHERE type='banner'";
 $queryset='';
...
{?>
      ...
      <div class="row col_12 mB0">
		...
		while($row = mysql_fetch_assoc($queryset))
{?>
            <img src="./media/home/banner/<?php echo $row["image"]?>" class="fullWidth"/>
              <div class="text-area">
        ...
        <div class="col_4 small-art allM">
            ...
            <div class="col_12 fullWidth mL2 mB0">
            	<img src="media/images/home/960_home_Image3.png" class="col_12 mT0 fullWidth" />
              <div class="text-area">
            ...
            <div class="col_12 fullWidth mL2 mT2 mB0">
            	<img src="media/images/home/960_home_Image4.png" class="col_12 mT0 fullWidth"/>
              <div class="text-area">
                <div class="caption-head txt-center font-head-mid">Privileged life - ABOUT US</div>
              </div>
            </div>
      ...
      <div class="col_12 lookBook">
        <div class="col_4 allM mL0">
           	<img src="media/images/home/960_home_Image5.png" class="col_12 allM fullWidth" />
        </div>
        
        <div class="col_8 mid-art allM">
          	<img src="media/images/home/960_home_Image6.png" class="col_12 fullWidth mT0 mB0" />
            <div class="text-area">
      ...
      <div class="col_12" id="newsletter">
        ...
        <div class="col_8">
          <form>
            <div class="col_9" id="newsletter"><input type="email" value="Email Address...." class="col_12" /></div>
