...
else
{
  ...
  if(isset($_GET['id']))
  {
	...
	$selectSQL='SELECT * FROM banner WHERE id='.$id;
	$queryset='';
...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the form to edit the Banner</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification success png_bg" <?php echo($success); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Banner edited Successfully. </div>
            </div>
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while editing Banner. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_editbanner.php" method="post" enctype="multipart/form-data" name="editbanner" id="editbanner">
            <fieldset>
                ...
                <input name="hiddenid" type="hidden" id="hiddenid" value="<?php echo($id); ?>" />
                  ...
                  <p>
                <label> Title <span id="Banner_name_spry">
                   ...
                   <p> <img src="../media/home/banner/<?php echo ($image); ?>" />
                <label>Image Upload (current image: <?php echo($image); ?> )</label>
                <input name="image" type="file" class="text-input" id="image" value="<?php echo($image); ?>" />
              </p>
                    <p>
                <label>Content<br />
