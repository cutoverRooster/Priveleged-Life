...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the form to upload a new Dealer</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification success png_bg" <?php echo($success); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Dealer Uploaded Successfully. </div>
            </div>
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while Uploading Dealer. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_adddealer.php" method="post" enctype="multipart/form-data" name="addproduct" id="addproduct">
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
                  <label>Name<br/>
                   <span id="dealer_name_spry">
                <input name="name" type="text" class="text-input medium-input" id="name" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <p>
                  <label> Address<br/>
                   <span id="dealer_name_spry">
                <input name="address" type="text"  class="text-input medium-input" id="address" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <label> City<br/>
                  <span id="dealer_name_spry">
                <input name="city" type="text" class="text-input medium-input" id="city" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
                  <label> State<br/>
                   <span id="dealer_name_spry">
                <input name="state" type="text" class="text-input medium-input" id="state" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                  <p>
                 <label>Select Country<br/>   <select id="country" name ="country"></select>
                 <script language="javascript">print_country("country")</script>  </label>
                  </p>
                   <p>
                  <label> Zip <br/>
                  <span id="dealer_name_spry">
                <input name="zip" type="text" class="text-input medium-input" id="zip" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
                  <label> Phone <br/>
                  <span id="dealer_name_spry">
                <input name="phone" type="text" class="text-input medium-input" id="phone" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                   <p>
              <label>Sort Order<br/>
...
<script type="text/javascript">
<!--
var sprytextfield8 = new Spry.Widget.ValidationTextField("dealer_cat");
var sprytextfield6 = new Spry.Widget.ValidationTextField("new_loc_spry");
var sprytextfield7 = new Spry.Widget.ValidationTextField("dealer_name_spry");
