...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <div class="content-box">
        ...
        <h3>Fill in the form to upload a new banner</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification success png_bg" <?php echo($success); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Banner Uploaded Successfully. </div>
            </div>
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while Uploading Banner. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_addbanner.php" method="post" enctype="multipart/form-data" name="addbanner" id="addbanner">
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
                  <label> Title<br/>
                  <span id="banner_name_spry">
            ...
            <p>
                  <label>Image [940px * 461px]</label>
                  <input name="image" type="file" class="text-input" id="image" />
                </p>
              <p>
                  <label>Content<br/>
                  <span id="banner_name_spry">
                <input name="content" type="text" class="text-input medium-input" id="content" />
                <span class="textfieldRequiredMsg">A value is required.</span> </label>
                  </span> </p>
                <p>
              <label>Sort Order<br/>
              <span id="lookbook_name_spry">
...
while($row = mysql_fetch_assoc($queryset))
{
  if($i==1){
    $i=2;
    echo ('<tr><td><table><tr><td><img src="../media/home/banner/'.$row["image"].'" width="180px" height="120px" style="margin:0;"/></td></tr>');
    echo('<tr><td>'.$row['title'].'</td><td>'.$row['sort'].'</td>
    <td>
    <a href="editbanner.php?id='.$row['id'].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
    <a href="process_delbanner.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr></table></td>');

  }elseif($i==2){
    $i=3;
    echo ('<td><table><tr><td><img src="../media/home/banner/'.$row["image"].'" width="180px" height="120px" style="margin:0;"/></td></tr>');
    echo('<tr><td>'.$row['title'].'</td><td>'.$row['sort'].'</td>
    <td>
    <a href="editbanner.php?id='.$row['id'].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
    <a href="process_delbanner.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr></table></td>');
    ...
    <td>
    <a href="editbanner.php?id='.$row['id'].'" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
    <a href="process_delbanner.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr></table></td></tr>');
...
<script type="text/javascript">
<!--
var sprytextfield8 = new Spry.Widget.ValidationTextField("banner_cat");
var sprytextfield6 = new Spry.Widget.ValidationTextField("new_loc_spry");
var sprytextfield7 = new Spry.Widget.ValidationTextField("banner_name_spry");
