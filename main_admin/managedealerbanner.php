...
<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    ...
    <!-- Page Head -->
    <h2>Add New Dealer Banner</h2>
    <div class="content-box">
          <!-- Start Content Box -->
          <div class="content-box-header">
        <h3>Fill in the form to upload a new dealer banner</h3>
        <div class="clear"></div>
      </div>
        ...
        <div class="notification success png_bg" <?php echo($success); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Banner Deleted Successfully. </div>
            </div>
        <div class="notification error png_bg" <?php echo($failure); ?>> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
              <div> Error Occurred while Deleting Banner. </div>
            </div>
        <div class="tab-content default-tab">
              <form action="process_adddealerbanner.php" method="post" enctype="multipart/form-data" name="adddealer" id="adddealer">
...
<td>
<a href="process_deldealerbanner.php?id='.$row['id'].'" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a></td></tr>');
}
