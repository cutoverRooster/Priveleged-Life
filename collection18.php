...
<? $jindex = 1;
while ($jindex < 64){?>
	$('#gallery-<? echo $jindex; ?>').royalSlider({
fullscreen: {
enabled: false,
nativeFS: false
},
...
$(".inline<? echo $prodindex.$seasonIndex; ?>").colorbox({inline:true});
});
</script>
                    <div class="col_6">
                      <div class="col_12 allM"> <a class='inline<? echo $prodindex.$seasonIndex; ?>' href="#inline_content<? echo $prodindex.$seasonIndex; ?>">
                        ...
                        <div style='display:none;' class="collectionPopupHide">
                          <div id='inline_content<? echo $prodindex.$seasonIndex; ?>' style='padding:10px; background:#fff; position:relative;'>
                            <div class="main mT20">
                              <div id="gallery-<? echo $prodindex; ?>" class="royalSlider rsMinW fwImage">
